...
var OtherKey = `[{"cookie":"pt_key=AAJidkExADAfCoPYqsxwSDo58thFwMAZd1_58IB9IUElAAFHeEZJMXND_ywL2uVm-nWssZJufm8;pt_pin=jd_72476e50d1b0e;","jrBody":""}]`; //无限账号Cookie json串数据, 请严格按照json格式填写, 具体格式请看以下样例:
